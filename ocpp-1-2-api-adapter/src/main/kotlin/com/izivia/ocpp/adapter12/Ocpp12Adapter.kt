...
class Ocpp12Adapter(
    ...
    companion object {
        private val logger = LoggerFactory.getLogger(Ocpp12Adapter::class.java)
    }

    private val operations: ChargePointOperations = ChargePointOperations
        .newChargePointOperations(chargingStationId, transport, Ocpp12CSApiAdapter(csApi, transactionIds))
    ...
    override fun dataTransfer(
        meta: RequestMetadata,
        request: com.izivia.ocpp.api.model.datatransfer.DataTransferReq
    ): OperationExecution<com.izivia.ocpp.api.model.datatransfer.DataTransferReq, com.izivia.ocpp.api.model.datatransfer.DataTransferResp> {
        throw IllegalStateException("DataTransfer can't be called in OCPP 1.2")
    }
    ...
    override fun notifyReport(
        ...
        throw IllegalStateException("NotifyReport can't be call in OCPP 1.2")
    }
    ...
    override fun clearedChargingLimit(
        ...
        throw IllegalStateException("clearedChargingLimit can't be call in OCPP 1.2")
    }
    ...
    override fun getCertificateStatus(
        ...
        throw IllegalStateException("GetCertificateStatus can't be call in OCPP 1.2")
    }
    ...
    override fun notifyCustomerInformation(
        ...
        throw IllegalStateException("notifyCustomerInformation can't be call in OCPP 1.2")
    }
    ...
    override fun notifyEvent(
        ...
        throw IllegalStateException("NotifyEvent can't be call in OCPP 1.2")
    }
    ...
    override fun notifyChargingLimit(
        ...
        throw IllegalStateException("NotifyChargingLimit can't be call in OCPP 1.2")
    }
    ...
    override fun notifyDisplayMessages(
        ...
        throw IllegalStateException("notifyDisplayMessages can't be call in OCPP 1.2")
    }
    ...
    override fun notifyEVChargingNeeds(
        ...
        throw IllegalStateException("NotifyEVChargingNeeds can't be call in OCPP 1.2")
    }
    ...
    override fun publishFirmwareStatusNotification(
        ...
        throw IllegalStateException("PublishFirmwareStatusNotification can't be call in OCPP 1.2")
    }
    ...
    override fun notifyMonitoringReport(
        ...
        throw IllegalStateException("NotifyMonitoringReport can't be call in OCPP 1.2")
    }
    ...
    override fun reservationStatusUpdate(
        ...
        throw IllegalStateException("ReservationStatusUpdate can't be call in OCPP 1.2")
    }
    ...
    override fun securityEventNotification(
        ...
        throw IllegalStateException("SecurityEventNotification can't be call in OCPP 1.2")
    }
    ...
    override fun signCertificate(
        ...
        throw IllegalStateException("SignCertificate can't be call in OCPP 1.2")
    }
    ...
    override fun reportChargingProfiles(
        ...
        throw IllegalStateException("ReportChargingProfiles can't be call in OCPP 1.2")
    }
}
