...
class OkHttpOcppWampClientImpl(private val target: Uri, val ocppId:CSOcppId, val ocppVersion: OcppVersion, val timeoutInMs:Long = 30_000) : OcppWampClient {
    ...
    companion object {
        ...
        private val logger = LoggerFactory.getLogger(OkHttpOcppWampClientImpl::class.java)
